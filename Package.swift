...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "Cryptor", url: "https://github.com/WindowsMEMZ/BlueCryptor.git", branch: "master"),
        .package(name: "CryptorECC", url: "https://github.com/Kitura/BlueECC.git", branch: "master"),
